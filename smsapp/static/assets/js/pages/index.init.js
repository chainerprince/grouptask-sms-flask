...
!(function () {
  var n = "users-chat",
    l = "assets/images/users/user-dummy-img.jpg",
    o = "users",
    s = window.location.origin + "/doot/layouts/assets/js/api/",
    c = "",
    d = 1;
  function a() {
        ...
        e.addEventListener("click", function (e) {
          ...
          s &&
            ...
            (t = document.getElementsByClassName(s)) &&
              ...
              (document.querySelector(".user-chat-overlay").style.background =
                a),
          ...
          n &&
            ...
            t &&
              ...
              (document.querySelector(".user-chat").style.backgroundImage =
                r)));
        });
      });
  var r = document.querySelector("#chatinput-form"),
        ...
        : ((function (e, t) {
            ...
            s.querySelectorAll(".delete-item").forEach(function (e) {
              ...
              s.querySelectorAll(".copy-message").forEach(function (e) {
                e.addEventListener("click", function () {
                  s.childNodes[1].children[1].firstElementChild.firstElementChild.getAttribute(
                    "id"
                  );
                  (isText =
                    s.childNodes[1].children[1].firstElementChild
  ...
  for (
    var b = document.getElementsByClassName("favourite-btn"), x = 0;
    x < b.length;
    x++
  ) {
    var w = b[x];
  ...
  function S(e, t, a, s, i) {
    ...
    if (null != t)
      ...
      for (r += '<div class="message-img mb-0">', x = 0; x < a.length; x++)
        r +=
  ...
  function q(e) {
    ...
    (t = e),
      (a = function (e, t) {
        ...
        null !== e
          ? console.log("Something went wrong: " + e)
          : ((r = "users" == o ? t[0].chats : t[0].channel_chat),
